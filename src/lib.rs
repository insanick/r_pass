...
/// 
pub fn quick_build() {
    // Quickly creates a random string

    // Create an array containing the keys we will use
    ...
    // Initialize the Rng, the password string, and the current_char placeholder
...
/// Constructor for the Password struct. 
/// 
/// Calls private functions that will prompt the user
impl Password {
